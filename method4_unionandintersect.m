...
%GFP-Cy5
rGFP_Cy5 = calculateMetrics(maskCy5, ICy5, maskGFP, IGFP)
rTRITC_Cy5 = calculateMetrics(maskTRITC, ITRITC, maskCy5, ICy5)
...
function rr = calculateMetrics(mask1, I1, mask2, I2)

maskIntersect = mask1 & mask2;
maskUnion = mask1 | mask2;

rr = nnz(maskIntersect)/nnz(maskUnion);
